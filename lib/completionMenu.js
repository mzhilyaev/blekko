...
try{
    ...
    console.log( preferences.get( COMPLETION_MENU_USE_CONTEXT , "true") );
    console.log( preferences.get( COMPLETION_MENU_PREVIEW , "true") );
	...
	this.previewItem.addEventListener("command", function( event ) {
			    console.log( this.previewItem.hasAttribute("checked") );
    ...
    this.preselectItem.setAttribute("checked", preferences.get( COMPLETION_MENU_PRESELECT , "false"));
    this.preselectItem.setAttribute("type", "checkbox");
    this.preselectItem.addEventListener("command", function( event ) {
                console.log( this.preselectItem.hasAttribute("checked") );
